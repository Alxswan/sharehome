...
Home.destroy_all
h1 = Home.create :address => '191 Australia Street', :description => 'House', :password => 'chicken', :name => 'Straya Street'
h2 = Home.create :address => '217 Cullens Rd', :description => 'House', :password => 'chicken', :name => 'Home'
